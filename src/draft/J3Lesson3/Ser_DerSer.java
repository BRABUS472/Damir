...
public class Ser_DerSer {
   ...
   // Book book = new Book("book");
    //students.book = book;
    ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("Damir/src/draft/J3Lesson3/stud.ser"));
        oos.writeObject(students);
        oos.close();

        //десериализация
    ObjectInputStream ois = new ObjectInputStream(new FileInputStream("Damir/src/draft/J3Lesson3/stud.ser"));
